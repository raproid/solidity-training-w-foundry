...
import {HelperConfig, CodeConstants} from "../../script/HelperConfigRaffle.s.sol";
...
contract RaffleTest is Test, CodeConstants {
    ...
    function testDontAllowPlayersToEnterWhileRaffleIsCalculating() public {
        ...
        vm.roll(block.number + 1); // Move to next block to trigger upkeep
    ...
    function testPerformUpkeepUpdatesRaffleStateAndEmitsWinnerPicked() public raffleEntered {
        // Act
        vm.recordLogs();
        raffle.performUpkeep("");
